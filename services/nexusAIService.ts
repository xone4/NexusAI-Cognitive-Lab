...
const getSystemInstruction = (activeExpert?: ExpertPersona) => {
    ...
    **PLANNING PROTOCOL:**
    ...
    For each step, you MUST also provide a 'rationale' property: a brief, one-sentence explanation for *why* you chose that specific tool for that task.
